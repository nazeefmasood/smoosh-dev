...
export function createActionContextProvider({ getActionContext = null } = {}) {
  return (...args) =>
...
export function appendCompatibleActionContext(
  payload = {},
  actionContext = null,
) {
...
export function getActionContextFromIntentGate(
  intentGate = null,
  candidate = null,
) {
