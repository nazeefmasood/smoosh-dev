...
export function resolveImageSessionContext({
  ...
  const extractedImageAssetIds =
    typeof resolveAssetIds === 'function' && resolvedImageElement
      ? resolveAssetIds(resolvedImageElement)
      : null;
  const extractedTargetAssetIds =
    typeof resolveAssetIds === 'function' && target
