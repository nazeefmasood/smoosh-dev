...
export function runCurrentAlphaTrialSequence({ stages = [] } = {}) {
  const results = [];
...
export function runCurrentAlphaTrialSpecPhase({ createSpecs } = {}) {
...
export function runCurrentAlphaStageSequence({ stages = [] } = {}) {
  const results = [];
  for (const stage of stages) {
...
export function runCurrentAlphaStageSpecPhase({ createSpecs } = {}) {
...
export function runCurrentRepairStageSequence({ stages = [] } = {}) {
  const results = [];
  for (const stage of stages) {
...
export function runCurrentRepairStageSpecPhase({ createSpecs } = {}) {
  return runCurrentRepairStageSequence({
    stages: typeof createSpecs === 'function' ? createSpecs() : [],
  });
}

export function runRepairCleanupSpecPhase({ createSpecs } = {}) {
