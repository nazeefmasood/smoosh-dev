...
export function createAcceptedPipelineState({ initialSelection = null } = {}) {
...
export function createPipelineStateCommit({ current, result, source } = {}) {
...
export function createPipelineStateAccessors({ get, set } = {}) {
