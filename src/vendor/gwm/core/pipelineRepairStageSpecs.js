  ...
  return {
    createCleanup: () => {
      ...
      const previewBackgroundBorderStd =
        ...
        typeof measureOuterBorderLuminanceStd === 'function'
          ? measureOuterBorderLuminanceStd(state.finalImageData, state.position)
          : 0;
      const shouldApply =
        typeof shouldApplyPreviewSmoothBackgroundCleanup === 'function'
          ? shouldApplyPreviewSmoothBackgroundCleanup({
      ...
      const cleaned =
        typeof applyPreviewSmoothBackgroundCleanup === 'function'
          ? applyPreviewSmoothBackgroundCleanup({
      ...
      const cleanedMetrics =
        typeof createRegionCorrelationMetrics === 'function'
          ? createRegionCorrelationMetrics({
      ...
      return {
        ...
        currentNearBlackRatio:
          typeof calculateNearBlackRatio === 'function'
...
export function createPostLocatedRepairStageSequenceSpecs({
  ...
  return [
    ...
    },
    {
      ...
      createStage: () => {
        const state = readPipelineRepairState(readState);
        return typeof refineSmoothLocatedResidualWithEstimatedPrior ===
          'function'
          ? refineSmoothLocatedResidualWithEstimatedPrior({
              originalImageData,
              currentImageData: state.finalImageData,
