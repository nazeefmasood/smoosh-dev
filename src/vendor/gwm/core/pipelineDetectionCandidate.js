...
export function createDetectionCandidateContractSummary(
  ...
  return {
    ...
    hasConfig:
      detectionCandidate?.config !== null &&
      detectionCandidate?.config !== undefined,
    hasPosition:
      detectionCandidate?.position !== null &&
      detectionCandidate?.position !== undefined,
    productionEvidence:
      detectionCandidate?.evidence?.productionEvidence === true,
  };
}
